...
function ActiveStepFormComponent() {
  ...
  switch (step) {
    ...
    case 2:
      return <DispersalRecipient onHandleNext={handleNext} onHandleBack={handleBack} />
    case 3:
        ...
        <div className="flex flex-col md:flex-row w-full max-w-8xl flex-grow gap-4">
          <FormProvider>
            ...
            <div className="p-6 w-full md:w-3/4 border rounded-xl bg-white flex-grow">
              <h1 className="text-center text-2xl font-semibold py-4 text-cyan-600 font-bold:base">
                Disperse
              </h1>
